...
public class DeviceController {
    ...
    public ResponseEntity<DeviceResponse> register(
        ...
        // The organization must exist and already have an edge gateway: a device is
        // served and authenticated by its org's edge, so the edge is registered first.
        ...
        DeviceId deviceId = this.commandService.handle(request.toCommand(organizationId));
